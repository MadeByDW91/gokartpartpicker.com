...
import { ChevronLeft, Zap, TrendingUp, TrendingDown } from 'lucide-react';
                ...
                >
                  ...
                  {engines?.map(engine => (
                    <option key={engine.id} value={engine.id}>
                      {engine.name} ({engine.horsepower} HP)
                    </option>
                  ))}
                </select>
                {selectedEngine && (
                    ...
                    <div className="p-4 bg-olive-800 rounded-lg border border-olive-600">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xl font-bold text-cream-100">{selectedEngine.name}</p>
                        </div>
